  ...
  <footer class="main-footer">
    ...
    <strong>ไปที่ Website หลักของ <a href="https://www.ssupercable.com/"target="_blank">S.SUPER CABLE</a></strong>
...
<script>
  Swal.fire({
  title: 'สำเร็จ',
  text: 'แก้ไขข้อมูลของคุณ <?php echo $row['mem_name'];?> สำเร็จ',
  icon: 'success',
  confirmButtonText: 'ตกลง'
})
</script>
...
<script>
  Swal.fire({
  title: 'สำเร็จ',
  text: 'แก้ไขข้อมูล <?php if ($row['pv_l_id']==1) {
      echo "VCT";
      }else{
      echo "VCT-G";
      } ?> สำเร็จ',
